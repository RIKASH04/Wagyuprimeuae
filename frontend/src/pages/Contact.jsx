...
const Contact = () => {
  ...
  return (
    <div data-testid="contact-page" className="bg-[#1A1A1A]">
      <section className="pt-20 md:pt-28 pb-10 md:pb-14">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10">
          <Reveal>
            ...
            <h1 className="font-display text-5xl md:text-7xl text-white leading-[0.95] tracking-tight max-w-4xl">
              Let&apos;s talk about <em className="italic text-[#C9A84C]">your steak.</em>
            </h1>
            <p className="mt-5 text-white/70 max-w-2xl text-balance">
          ...
          <form onSubmit={onSubmit} data-testid="contact-form" className="space-y-7">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-transparent border-b border-[#C9A84C]/30 focus:border-[#C9A84C] outline-none text-white py-2 placeholder-white/30 resize-none"
        ...
        <aside className="col-span-12 md:col-span-4 md:col-start-9 space-y-10">
          <Reveal>
            <a
              ...
              className="group flex items-center justify-between gap-4 border border-[#25D366] hover:bg-[#25D366] hover:text-[#0F0F0F] text-[#25D366] px-6 py-5 transition-colors"
            >
              <div className="flex items-center gap-3">
                <MessageCircle size={20} />
                <div>
                  <div className="font-heading text-[10px] tracking-[0.3em] uppercase">Chat on WhatsApp</div>
                  <div className="text-sm mt-1">{SITE.whatsappDisplay}</div>
                </div>
              </div>
          ...
          <div className="border-t border-[#C9A84C]/15 pt-7">
            <div className="font-heading text-[10px] tracking-[0.32em] uppercase text-[#C9A84C] mb-4">Follow</div>
            <div className="flex items-center gap-4">
              <a aria-label="Instagram" href={SITE.social.instagram} className="w-10 h-10 border border-[#C9A84C]/40 hover:border-[#C9A84C] hover:text-[#C9A84C] flex items-center justify-center transition-colors">
                <Instagram size={16} />
              </a>
              <a aria-label="Facebook" href={SITE.social.facebook} className="w-10 h-10 border border-[#C9A84C]/40 hover:border-[#C9A84C] hover:text-[#C9A84C] flex items-center justify-center transition-colors">
                <Facebook size={16} />
              </a>
            </div>
          </div>
...
const Field = ({ label, name, value, onChange, type = 'text', required, testid }) => (
  <div>
    ...
    <input
      ...
      required={required}
      data-testid={testid}
      className="w-full bg-transparent border-b border-[#C9A84C]/30 focus:border-[#C9A84C] outline-none text-white py-2 placeholder-white/30"
    />
  </div>
);
